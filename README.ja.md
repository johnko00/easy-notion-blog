...
1. 初期化スクリプトを実行します `DATABASE_ID=69e91acd3bd8438dace7ffa90571103a NOTION_API_SECRET=secret_uBdVkF712qrtaR3Jl8LVtuJEzgVvD207b5gGzk7ADmw ./scripts/init-database.sh`
